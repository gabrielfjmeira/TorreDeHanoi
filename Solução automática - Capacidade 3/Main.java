...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        pilhaGabarito = new Pilha(capacidade);
        ...
        //Gera a pilha de gabarito
        Operacoes.gerarPilhaGabarito(pilha1);
